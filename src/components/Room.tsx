  ...
  return (
    ...
    >
      ...
      <header className="room-header relative z-30 safe-top px-4 pb-2">
        ...
        <div className="room-status-row mx-auto mt-1 flex w-full max-w-md gap-1.5">
          {weatherActive && (
            <button
              type="button"
            ...
            >
              ...
              <span className="min-w-0 text-left font-serif">
                <span className="block whitespace-nowrap text-xs leading-none text-warm-100/82">
                  {state.world.current ? `${Math.round(state.world.current.temperatureC)}°` : t('Weather', 'Pogoda')}
                </span>
                <span className="mt-0.5 block max-w-[6.2rem] truncate whitespace-nowrap text-[7.5px] leading-none text-warm-200/46">
          ...
          <button
            ...
            className="room-needs-control flex min-h-8 min-w-0 flex-1 items-center gap-1.5 rounded-full border border-warm-200/8 bg-room-dark/55 px-2.5 py-1 text-left shadow-md backdrop-blur-md transition-colors hover:bg-room-dark/70"
          >
